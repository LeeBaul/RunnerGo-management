...
func InsertDelete(ctx context.Context, teamID, userID int64, name string) error {
	return insert(ctx, teamID, userID, name, consts.OperationCategoryDelete)
}

func InsertRun(ctx context.Context, teamID, userID int64, name string) error {
	return insert(ctx, teamID, userID, name, consts.OperationCategoryRun)
}
