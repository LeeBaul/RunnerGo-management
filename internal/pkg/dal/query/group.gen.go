...
func newGroup(db *gorm.DB) group {
	...
	_group.TargetID = field.NewInt64(tableName, "target_id")
	_group.Request = field.NewString(tableName, "request")
	_group.Script = field.NewString(tableName, "script")
...
func (g *group) updateTableName(table string) *group {
	...
	g.TargetID = field.NewInt64(table, "target_id")
	g.Request = field.NewString(table, "request")
	g.Script = field.NewString(table, "script")
...
func (g *group) fillFieldMap() {
	...
	g.fieldMap["id"] = g.ID
	g.fieldMap["target_id"] = g.TargetID
	g.fieldMap["request"] = g.Request
	g.fieldMap["script"] = g.Script
