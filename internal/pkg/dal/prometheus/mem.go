...
func GetMemRangeUsage(ip string, s, e int64) ([][]interface{}, error) {
	u := url.URL{
		...
		RawQuery: "start=1661911200&end=1661911500&step=15&query=(node_memory_MemTotal_bytes-node_memory_MemAvailable_bytes)/node_memory_MemTotal_bytes{instance=\"172.17.101.188:9100\"}",
	}
